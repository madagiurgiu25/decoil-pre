...
optional arguments:
  ...
  --sv-caller SV_CALLER
                        SV caller name matching the VCF input ['sniffles1',usage: decoil reconstruct -b [bamfile] -i <vcffile> -c <coveragefile> --outputdir <outputdir> --name <sample> -r <reference_genome>
...
optional arguments:
  ...
  --min-cov MIN_COV     Minimal coverage on site (default: 8X)
  --sv-caller SV_CALLER
                        SV caller name matching the VCF input ['sniffles1', 'sniffles2', 'lumpy', 'multivcf']
